...
| `AI_HardSI_bt.smx` | 特感 AI 强化 — 行为树 v4.0.4（引擎数值实测校准：Smoker 拉人/Charger 冲锋冷却簇消除挠击 + 冲锋距离 750 真生效 + Smoker 孤立度选人恢复 + Hunter 高位扑距离门控 + **Boomer 呕吐射程 500/550→300 对齐引擎**），精准扑击/冲锋/连跳/协同攻击；引擎基准见 `scripting/AI_HardSI_optimized/ENGINE_CVARS.md` |
