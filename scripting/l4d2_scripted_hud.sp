...
// Cvar Flags
// ====================================================================================================
#define CVAR_FLAGS                    0				// [suli 2026-08-26] 去除 NOTIFY: 本插件 text cvar 被 scoreboard_ui 每秒喂值, NOTIFY 会导致全服聊天刷屏"服务器 xxx 参数改为 yyy"
...
public void OnPluginStart()
{
    ...
    AutoExecConfig(true, CONFIG_FILENAME);	// [suli 2026-08-26] 启用: 无 cfg 时换图/重载会把布局打回编译默认值(hud3_team 默认=2 仅感染者可见 → 榜单消失)
