...
#define PLUGIN_VERSION "1.16.6"   // v1.14.0: 火力支援全线+2000 (用户拍板 2026-08-25)——汽油弹12000/胆汁雨8500/榴弹雨16500/AGM20000
...
#define ART5_MIN_PER_SEC 3        // v1.16.1: 榴弹总量再+15%(用户拍板) 槽×3-5 ≈ 45-75(avg60, 原45-60)
#define ART5_MAX_PER_SEC 5
...
ShopItem g_ShopTable[SHOP_SLOTS] = {
    ...
    { "火力支援II-汽油弹", "artillery2",                 12000,   0,  4 },  // v1.14.0: +2000 (10000→12000, 用户拍板火力支援全线+2000)
    { "火力支援I-胆汁雨", "artillery3",             8500,  0,  4 }   // v1.14.0: +2000 (6500→8500)
    // v1.3.0: 支援V-混合轰炸 → v1.4.0 转正定稿「火力支援III-区域轰炸」5500/30s
    // （罐+榴弹 1:1；原火力支援I-炮击 artillery + IV-榴弹雨 artillery4 已禁用，表行删除）
    , { "火力支援III-榴弹雨", "artillery5",               16500,  0,  4 }   // v1.14.0: +2000 (14500→16500)
    ...
    , { "火力支援IV-AGM导弹", "artillery6",                  20000,  0,  4 }   // v1.14.0: +2000 (18000→20000)
...
public APLRes AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
    ...
    MarkNativeAsOptional("SH_ShowMissileBanner");   // v1.16.5b: 21:11 换图三度翻车——全量清点 398-421 行 native 声明逐个标记, 不再打地鼠
