...
// Game tries to reset these cvars — keep them locked
public OnTongueCvarChange(Handle:convar, const String:oldValue[], const String:newValue[]) {
...
public OnSmokerHealthChanged(Handle:convar, const String:oldValue[], const String:newValue[]) {
	SetConVarInt(hCvarChokeDamageInterrupt, GetConVarInt(hCvarSmokerHealth));
}